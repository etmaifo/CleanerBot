...
class BuildExe:
    def __init__(self):
        ...
        #Auhor of program
        self.author_name = "Tokelo Maifo"
        self.author_email = "contact@phyrebotcentral.com"
        self.copyright = "Copyright (c) 2016 Tokelo Maifo."
 
        #Description
        self.project_description = "A local multiplayer 2d arcade game"
